        ...
        if agree:
            ...
            if st.button('Next'):
                ...
                with st.form(key = "my_form"):
                    ...
                    export_impact = st.radio("Select one of the options below:", options=["Positive", "Negative", "No changes"], horizontal=False)
                    ...
                    if export_impact == "Positive":
                        ...
                        prob_slider = st.slider("Select the probability sliding on the bar below:", 0, 100)
                        ...
                        prob_slider_neg = st.slider("Select the probability sliding on the bar below:", 0, 100)
                        st.write("Please shortly summarize the reasons for your previous answer:")
                        ...
                        prob_slider_neutral = st.slider("Select the probability sliding on the bar below:", 0, 100)
                        st.write("Please shortly summarize the reasons for your previous answer:")
